...
<div class='header'>
	...
	<div class='body-container'>
		<form class="form-addpatient" action="addpatient" method="post">
        	...
        	<input type="text" name="birthdate" id="inputBirthdate" class="form-control" placeholder="" required="" autofocus=""> 
        	<br>
        	<br>
        	<label for="inputAffiliateNHP" class="sr-only">Affiliate Number Health Plan :</label>
        	<input type="text" name="affiliateNHP" id="inputAffiliateNHP" class="form-control" placeholder="" required="" autofocus=""> 
        	<br>
        	<br>
        	
        	<button class="btn" type="submit" name="btnRegister" id="btnRegister" >Register</button>
